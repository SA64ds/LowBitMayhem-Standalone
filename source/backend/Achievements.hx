...
class Achievements {
	public static function init()
	{
		...
		createAchievement('bitbeat_nomiss',			{name: "Bit Master", description: "Beat Bit-Beat on Hard with no Misses."});
		createAchievement('so_retroacheivements',			{name: "So Retro!", description: "Find the secret song, SORETRO.", hidden: true});
		createAchievement('commitedtothebit',			{name: "Commited to the Bit", description: "Play Bit-Beat 64 times.", maxScore: 64, maxDecimals: 0});
